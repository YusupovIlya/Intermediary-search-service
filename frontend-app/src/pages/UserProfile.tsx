    ...
    return(
        <div className="p-2">
            ...
            <div className="mt-10 text-center pb-2">
                <h1 className="text-2xl font-medium text-gray-700">Мои контакты</h1>
                <p className="font-light text-gray-600 mt-3">Telegram</p>
                <p className="font-light text-gray-600 mt-3">Whatsapp</p>
